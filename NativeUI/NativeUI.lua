...
function UIMenuPercentagePanel.New(Title, MinText, MaxText)
    _UIMenuPercentagePanel = {
        ...
        Text = {
            ...
            Title = UIResText.New(Title or "Opacity", 0, 0, 0.35, 255, 255, 255, 255, 0, "Centre"),
        },
        Audio = {Slider = "CONTINUOUS_SLIDER", Library = "HUD_FRONTEND_DEFAULT_SOUNDSET", Id = nil},
        ParentItem = nil,
    }
...
function NativeUI.CreatePercentagePanel(Title, MinText, MaxText)
    return UIMenuPercentagePanel.New(Title, MinText, MaxText)
end
